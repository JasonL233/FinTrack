package com.fintrack.transactionservice.entity;
...
@Table(name = "transactions", indexes = {
    // Index for faster database retrieval
...
public class Transaction {
    ...
    public Transaction(Long id, Long userId, BigDecimal amount, TransactionType type, 
    ...
    public static class Builder {
        ...
        public Transaction build() {
            return new Transaction(id, userId, amount, type, category, description, 
